...
import { ChevronRight, Mail, Phone, Store } from 'lucide-react';
...
export function AccountHeader({
    ...
    return (
        <div className="w-full overflow-hidden rounded-[14px] border border-slate-200 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.05)]">
            <button
                type="button"
                onClick={onOpen}
                aria-label="Lihat dan ubah profil"
                className="block w-full text-left focus-visible:ring-2 focus-visible:ring-[#0080FF] focus-visible:outline-none"
            >
