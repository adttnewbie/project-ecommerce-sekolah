    ...
    return (
        <>
            {(flash?.success || flash?.error) && (
                ...
                >
                    <CheckCircle2
                        className={`mt-0.5 size-4 shrink-0 ${flash.error ? 'text-rose-600' : 'text-emerald-600'}`}
                    />
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <CardDescription className="mt-1.5 line-clamp-none text-sm leading-5 text-slate-500">
                                Perbarui nama dan email akun. Perubahan akan
                                langsung terlihat di seluruh aplikasi.
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
